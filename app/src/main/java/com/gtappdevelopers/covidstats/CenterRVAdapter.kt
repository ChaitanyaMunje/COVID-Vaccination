...
class CenterRVAdapter(private val centerList: List<CenterRvModal>) :
    ...
    override fun onBindViewHolder(holder: CenterRVViewHolder, position: Int) {
        //on below line we are getting item from our list along with its position.
        val currentItem = centerList[position]
        //after getting current item we are setting data from our list to our text views.
        ...
        holder.centerTimings.text =
            ("From : " + currentItem.centerFromTime + " To : " + currentItem.centerToTime)
