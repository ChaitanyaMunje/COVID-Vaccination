package com.gtappdevelopers.covidstats
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //iniside on create method we are initializing all our variables which we have declared.
        ...
        //on below line we are adding on click listner to our button.
        searchButton.setOnClickListener {
            //inside on click listner we are getting data from edit text and creating a val for ite on below line.
            val pinCode = pinCodeEdt.text.toString()
            //on below line we are validating our pin code as 6 digit or not.
            if (pinCode.length != 6) {
                ...
                //first of all we are clearing our array list this will clear the data in it if already present.
                ...
                //on below line we are creaing our date picker dialog.
                val dpd = DatePickerDialog(
                    this,
                    DatePickerDialog.OnDateSetListener { view, year, monthOfYear, dayOfMonth ->
                        //after that we are making our proress bar as visible.
                        loadingPB.setVisibility(View.VISIBLE)
                        //on below line we are creating a date string for our date
                        val dateStr: String = """$dayOfMonth - ${monthOfYear + 1} - $year"""
                        //on below line we are calling a method to get the appointment info for vaccination centers and we are passing our pin code to it.
